                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">All Contact Messages</h4>
                        </div><!-- end card header -->
                                    ...
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="one">Contact</th>
                                                <th class="sort" data-sort="two">Subject</th>
                                        ...
                                        <tbody class="list form-check-all">
                                            ...
                                            <tr>
                                                ...
                                                <td class="one">{{ $a['contact'] }}</td>
                                                <td class="two">{{ $a['subject'] }}</td>
                                                
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <div class="edit">
                                                            <button class="btn btn-sm btn-success view-item-btn" data-bs-toggle="modal" data-bs-target="#myModal"
                                                            data-msg="{{ $a['message'] }}">Message</button>
                                                        </div>
                                                        <div class="remove">
                        ...
                        <div class="modal-body">
                            <div class="mt-2 text-center">
                                ...
                                <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                    <h4>Are you Sure ?</h4>
                                    <p class="text-muted mx-4 mb-0">Are you Sure You want to Delete this Message ?</p>
                                </div>
                            </div>
                            <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Close</button>
                                <form action="{{ route('admin.contactForm.delete') }}" method="POST">
                                    @csrf
