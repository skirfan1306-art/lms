                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4 card-bg-fill">
                            ...
                            <div class="card-body p-4">
                                ...
                                @endif
                                <div class="p-2 mt-4">
                                    <form class="needs-validation" action="{{ route('admin.register.action') }}" method="POST">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" id="useremail" name="email" placeholder="Enter email address" value="{{ $email }}" readonly required>                                           
                                        </div>                                       
