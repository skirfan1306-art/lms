                            ...
                            <div class="listjs-table" id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <a href="{{ route('admin.instructor.add') }}" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Add New Instructor</a>
                                        </div>
                                    </div>
                                    <div class="col-sm">
                                ...
                                <div class="table-responsive table-card mt-3 mb-1">
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        ...
                                        <tbody class="list form-check-all">
                                            ...
                                            <tr>
                                                <td>@if($data->image)
                                                    <a href="{{ asset('assets/front/images/instructor/'.$data['image']) }}" target="_blank"><img src="{{ asset('assets/front/images/instructor/'.$data['image']) }}" style="height:50px;width:auto" class="rounded"></a>
                                                    @else
                                                    <img src="{{ asset('assets/front/images/users/user-dummy-img.jpg') }}" style="height:50px;width:auto">
                                                    @endif
                                                </td>
                                                <td class="name"><a href="{{ route('admin.instructor.view', $data['id']) }}">{{ $data->name }} <br><small>({{ $data->designation }})</small></a></td>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <div class="view">
                                                            <a class="btn btn-sm btn-info" href="{{ route('admin.instructor.view', $data['id']) }}"><i class="bx bx-show"></i></a>
                                                        </div>
