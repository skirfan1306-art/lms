                        ...
                        <div class="card-body p-4">
                            <div class="text-center">
                                <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                    ...
                                    @if($user->image)
                                    <img src="{{ asset('assets/front/images/users/'.$user['image']) }}" class="rounded-circle avatar-xl img-thumbnail user-profile-image material-shadow">
                                    @else
                        ...
                        <div class="card-body p-4">
                            <div class="tab-content">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="firstnameInput" placeholder="Enter your firstname" value="{{ old('name', $user->name) }}" name="name">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="designation" class="form-label">Designation</label>
                                                    <input type="text" class="form-control" id="designation" placeholder="Enter your lastname" value="{{ old('designation', $user->designation) }}" name="designation">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="phonenumberInput" class="form-label">Phone Number</label>
                                                    <input type="text" class="form-control" id="phonenumberInput" placeholder="Enter your phone number" value="{{ old('number', $user->number) }}" name="number">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="emailInput" class="form-label">Email Address</label>
                                                    <input type="email" class="form-control" id="emailInput" placeholder="Enter your email" value="{{ old('email', $user->email) }}" name="email">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3 pb-2">
                                                    ...
                                                    <textarea id="summernote" name="description">{{ old('description', $user->description ) }}</textarea>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-12">
                                ...
                                <div class="tab-pane" id="changePassword" role="tabpanel">
                                    <form action="{{ route('admin.user.passupdate') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="id" value="{{ $user->id }}">
                                        <div class="row g-2">
                                            <div class="col-md-6">
