                ...
                <div class="card-body">
                    <div id="specifications">
                        @if(old('specification'))
                            @foreach(old('specification') as $index => $spec)
                                <div class="row mb-3 spec-row">
                                    <div class="col-lg-5">
                                        <input type="text" name="specification[]" class="form-control"
                                               placeholder="Specification" value="{{ $spec }}">
                                    </div>
                                    <div class="col-lg-5">
                                        <input type="text" name="value[]" class="form-control"
                                               placeholder="Value" value="{{ old('value')[$index] ?? '' }}">
                                    </div>
                                </div>
                            @endforeach
                        @else
                    ...
                    <div class="mt-3">
                        ...
                        <textarea id="summernote2" name="policy">{{ old('policy') }}</textarea>
