                            ...
                            <div class="listjs-table" id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <a href="{{ route('admin.product.add') }}" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Create New Product</a>
                                        </div>
                                    </div>
                                    <div class="col-sm">
...
<table class="table align-middle table-nowrap" id="medicineTable">
    ...
    <tbody class="list form-check-all">
        ...
        <tr>
            ...
            <td>
                <img src="{{ asset('assets/front/images/products/' . $p['thumbnail']) }}" alt="{{ $p['name'] }}" class="rounded avatar-sm">
            </td>
            ...
            <td>
                ...
                <b class="three">{{ number_format($p['sale_price'], 2) }}</b>
            </td>
            <td>
                @if($p['status'] == '1')
            ...
            <td>
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('admin.product.view', $p['id']) }}" class="btn btn-sm btn-info"> <i class="bx bx-show"></i> </a>
                    <a href="{{ route('admin.product.edit', $p['id']) }}" class="btn btn-sm btn-success"> <i class="bx bx-pen"></i> </a>
