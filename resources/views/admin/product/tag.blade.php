                            ...
                            <div class="listjs-table" id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#addAdmin"><i class="ri-add-line align-bottom me-1"></i> Add New Tag</button>
                                        </div>
                                    </div>
                                    <div class="col-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>                                                    
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <form action="{{ route('admin.tag.status') }}" method="POST" class="d-none">
                                                            @csrf
            ...
            <div class="modal fade" id="addAdmin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="tablelist-form" action="{{ route('admin.tag.create') }}" method="POST" autocomplete="off">
                            @csrf
            ...
            <div class="modal fade" id="editAdmin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="tablelist-form" autocomplete="off" action="{{ route('admin.tag.update') }}" method="POST">
                            @csrf
                            <div class="modal-body">                               
                            ...
                            <div class="modal-footer">
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                                    <button type="submit" class="btn btn-success" id="add-btn">Update Tag</button>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <div class="modal-body">
                            <div class="mt-2 text-center">
                                ...
                                <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                    <h4>Are you Sure ?</h4>
                                    <p class="text-muted mx-4 mb-0">Are you Sure You want to Delete this Tag ?</p>
                                </div>
                            </div>
