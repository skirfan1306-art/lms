                                            ...
                                            <tr>
                                                ...
                                                <td>                                                    
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <form action="{{ route('admin.blog.categoryStatus') }}" method="POST" class="d-none">
                                                            @csrf
            ...
            <div class="modal fade" id="addAdmin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="tablelist-form" action="{{ route('admin.blog.addCategory') }}" method="POST" autocomplete="off">
                            @csrf
            ...
            <div class="modal fade" id="editAdmin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="tablelist-form" autocomplete="off" action="{{ route('admin.blog.updateCategory') }}" method="POST">
                            @csrf
                            <div class="modal-body">                               
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                ...
                                <form action="{{ route('admin.blog.categoryDelete') }}" method="POST">
                                    @csrf
