                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Comment for - {{ $blog->title ?? 'No Blog Found' }}</h4>
                        </div><!-- end card header -->
                            ...
                            <div class="listjs-table" id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <a href="{{ route('admin.blogs') }}" class="btn btn-dark"><i class="ri-arrow-left-line"></i> Go Back</a>
                                        </div>
                                    </div>
                                    <div class="col-sm">
                                ...
                                <div class="table-responsive table-card mt-3 mb-1">
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        <thead class="table-light">
                                            <tr>
                                                <th>#</th>
                                                <th class="sort" data-sort="two">Name</th>
                                                <th class="sort" data-sort="name">Email</th>
                                                <th class="sort" data-sort="one">Comment</th>
                                                <th>Status</th>
                                                <th class="sort" data-sort="three">Time</th>
                                        ...
                                        <tbody class="list form-check-all">
                                            ...
                                            <tr>
                                                ...
                                                <td class="two">{{ $data->name }}</td>
                                                <td class="name">{{ $data['email'] }}</td>
                                                <td class="one">{{ $data['comment'] }}</td>
                                                ...
                                                <td class="three">{{ $data['created_at'] }}</td>

                                                <td>
                                                    <form action="{{ route('admin.blog.commentStatus') }}" method="POST" class="d-none">
                                                        @csrf
                        ...
                        <div class="modal-body">
                            <div class="mt-2 text-center">
                                ...
                                <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                    <h4>Are you Sure ?</h4>
                                    <p class="text-muted mx-4 mb-0">Are you Sure You want to Delete this Comment ?</p>
                                </div>
                            </div>
                            <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Close</button>
                                <form action="{{ route('admin.blog.comment.delete') }}" method="POST">
                                    @csrf
