                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">@if($date) Appointments for {{ \Carbon\Carbon::parse($date)->format('d F, Y') }} @else All Appointments @endif</h4>
                                    ...
                                    <div class="col-sm">
                                        <div class="d-flex justify-content-sm-end">
                                            ...
                                            <div class="search-box">
                                                <form action="{{ route('admin.appointment.search') }}" method="POST" class="d-flex">
                                                    @csrf
                                                    <input type="date" class="form-control me-3" name="date" value="{{ $date ?? '' }}">
                                                    <button type="submit" class="btn btn-success me-3" ><i class="ri-search-line search-icon"></i> Search</button>                                                
                                                    <a href="{{ route('admin.appointment') }}" class="btn btn-dark" >Reset</a>                                                
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="one">Service</th>
                                                <th class="sort" data-sort="two">Date & Slot</th>
                                                <th class="sort" data-sort="three">Location</th>
                                        ...
                                        <tbody class="list form-check-all">
                                            ...
                                            <tr>
                                                ...
                                                <td class="one">{{ $a->service->title }}</td>
                                                <td class="two">{{ $a['date'] ." - ". $a['slot'] }}</td>
                                                <td class="three">{{ $a['location'] }}</td>
                                                <td>
                                                    <a href="" class="badge {{ $class }} text-uppercase status cursor-pointer">{{ $a['status'] }}</a>
                                                </td>
                                                <td>
