                            ...
                            <div class="listjs-table" id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <h4 class="card-title mb-0">All Purchased Courses</h4>
                                    </div>
                                    <div class="col-sm">
                                ...
                                <div class="table-responsive table-card mt-3 mb-1">
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        <thead class="table-light">
                                            <tr>
                                                <th class="sort" data-sort="ten">#Order No</th>
                                                <th class="sort" data-sort="name">User</th>
                                                <th class="sort" data-sort="one">Total Amount</th>
                                                <th class="sort" data-sort="two">Discount</th>
                                                <th class="sort" data-sort="three">Pay Amount</th>
                                                <th class="sort" data-sort="four">Transaction ID</th>
                                                <th class="sort" data-sort="five">Payment</th>
                                                <th class="sort" data-sort="status">Status</th>
                                                <th class="sort" data-sort="six">Date</th>
                                        ...
                                        <tbody class="list form-check-all">
                                            ...
                                            <tr>
                                                ...
                                                <td class="ten">#<a href="{{ route('admin.order.view', $data['id']) }}">{{ $data->order_no }} </a></td>
                                                <td class="name">{{ $data->user->name }}</td>

                                                <td class="one">{{ $data->total_amount }}</td>
                                                <td class="two">{{ $data->coupon_discount ?? 0.00 }}</td>
                                                <td class="three">{{ $data->pay_amount }}</td>
                                                <td class="four">{{ $data->transaction_id }}</td>

                                                <td><label class="text-uppercase">{{ $data->payment_method }}</label>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($data['order_status'] == 'cancelled')
                                                        <label class="badge bg-danger-subtle text-danger">Cancelled</label>
                                                    @else
                                                        <label class="badge bg-warning-subtle text-warning">Expired</label>
                                                    @endif
                                                </td>
                                                
                                                <td class="six">{{ $data->created_at }}</td>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <div class="edit">
                                                            <a class="btn btn-sm btn-success" href="{{ route('admin.instructor.edit', $data['id']) }}"><i class="bx bx-pen"></i></a>
                                                        </div>
                                                        
                                                        <div class="view">
                                                            <a class="btn btn-sm btn-info" href="{{ route('admin.order.view', $data['id']) }}"><i class="bx bx-show"></i></a>
                                                        </div>
...
<div class="modal fade" id="editPass" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form class="tablelist-form" autocomplete="off" action="{{ route('admin.instructor.passupdate') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">                               
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" id="c_pass" name="confirm_pass" class="form-control" required />
                        ...
                        <div class="modal-body">
                            <div class="mt-2 text-center">
                                ...
                                <div class="mt-4 pt-2 fs-15">
                                    <h4>Are you Sure ?</h4>
                                    <p class="text-muted mx-4 mb-0">Are you Sure You want to Delete this Instructor ?</p>
                                </div>
                            </div>
                            <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Close</button>
                                <form action="{{ route('admin.instructor.delete') }}" method="POST">
                                    @csrf
