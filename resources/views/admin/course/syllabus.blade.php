                        ...
                        <div class="card-body">
                            <div class="listjs-table" id="customerList">
                                <div class="row g-4 mb-3">
                                    ...
                                    <div class="col-sm-auto">
                                        <div>
                                            <a href="{{ route('admin.course.syllabus.add', $course['id']) }}" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Create New Syllabus</a>
                                        </div>
                                    </div>
                                    <div class="col-sm">
...
<table class="table align-middle table-nowrap">
    ...
    <tbody class="list form-check-all" id="syllabusSortable">
        ...
        <tr class="handle" data-id="{{ $data['id'] }}">
            ...
            <td>
                <a href="{{ route('admin.syllabus.lesson', $data['id']) }}" class="btn btn-sm btn-success">{{ $data->lesson_count }} Lesson <i class="bx bx-cog"></i></a>
            </td>
            <td>{{ $data['updated_at'] }}</td>
            <td>
                <div class="d-flex gap-2">
                    
                    <a href="{{ route('admin.course.syllabus.edit', $data['id']) }}" class="btn btn-sm btn-success"> <i class="bx bx-pen"></i> </a>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                ...
                                <form action="{{ route('admin.course.syllabus.delete') }}" method="POST">
                                    @csrf
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function saveNewOrder(tbody) {
        ...
        fetch("{{ route('admin.course.syllabus.sort') }}", {
            method: "POST",
            headers: {
