                            ...
                            <div class="listjs-table" id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <a href="{{ route('admin.course.add') }}" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Create New Course</a>
                                    </div>
                                    @if($name != 'All')
                                    <div class="col-sm-auto">
                                        <a class="btn btn-info" href="{{ route('admin.courses') }}"><i class="ri-eye-line align-bottom me-1"></i> Show All</a>
                                    </div>
                                    @endif
                                    <div class="col-sm">
...
<table class="table align-middle table-nowrap" id="medicineTable">
    ...
    <tbody class="list form-check-all">
        ...
        <tr>
            ...
            <td class="name"><a href="{{ route('admin.course.view', $data['id']) }}">{{ Str::limit($data['name'], 80) }}</a></td>
