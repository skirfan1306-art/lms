                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 class="mb-sm-0">Create New Course</h4>
                            </div>
                        </div>
                    </div>
...
<form action="{{ route('instructor.course.create') }}" method="post" enctype="multipart/form-data">
    @csrf
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="project-title-input" placeholder="Enter Course Name" name="name" value="{{ old('name') }}" required>
...
Free Trial 7 Days
Certificate Of Completion" rows="5">{{ old('benefit') }}</textarea>

</div>
                    
                    <div class="mb-3">
                        <label class="form-label">Small Excerpt</label>
                        <textarea class="form-control" name="excerpt" placeholder="Enter small excerpt within 250 word" maxlength="250" required>{{ old('excerpt') }}</textarea>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <label class="form-label cursor-pointer" for="project-thumbnail-img">
                            <img src="{{ asset('assets/imgprev.png') }}" style="max-height:250px;height:auto;width:100%"
                                 id="viewImage">
                        </label>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="form-check me-5">
                            <input class="form-check-input" type="radio" name="price" id="flexRadioDefault1" value="paid" checked>
                            <label class="form-check-label" for="flexRadioDefault1">Paid &nbsp;&nbsp;&nbsp;&nbsp;</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="price" id="flexRadioDefault2" value="free">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" id="old-input" placeholder="299" name="old_price" value="{{ old('old_price') }}">
                        @error('old_price') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-lg-6">
                        <label for="sale-input" class="form-label">Sale Price</label>
                        <input type="text" class="form-control" id="sale-input" placeholder="199" name="sale_price" value="{{ old('sale_price') }}">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-2">
                        ...
                        <select class="form-select" name="level">
                            ...
                            <option value="Elite" {{ old('level') == 'Elite' ? 'selected' : '' }}>Elite</option>
                        </select>
                    </div>

                    <div class="mt-2">
                        <label class="form-label">Duration</label>
                        <input class="form-control" placeholder="e.g. 3 Months" type="text" name="duration" value="{{ old('duration') }}">
                    </div>
                    ...
                    <div class="mt-2">
                        ...
                        <input class="form-control" placeholder="e.g. Web Designing, Business Plan"
                               type="text" name="search" value="{{ old('search') }}">
...
<script>
    ...
    function rebuildInput() {
        // create new DataTransfer to rebuild input.files
