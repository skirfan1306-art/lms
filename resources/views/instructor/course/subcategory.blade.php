                            ...
                            <div class="listjs-table" id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <button type="button" class="btn btn-info add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#addAdmin"><i class="ri-add-line align-bottom me-1"></i> Add New Subcategory</button>
                                    </div>
                                    @if($name != 'All')
                                    <div class="col-sm-auto">
                                        <a class="btn btn-info" href="{{ route('instructor.subcategory') }}"><i class="ri-eye-line align-bottom me-1"></i> Show All</a>
                                    </div>
                                    @endif
                                    <div class="col-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>                                                    
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <form action="{{ route('instructor.subcategory.status') }}" method="POST" class="d-none">
                                                            @csrf
            ...
            <div class="modal fade" id="addAdmin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="tablelist-form" action="{{ route('instructor.subcategory.create') }}" method="POST" autocomplete="off">
                            @csrf
                            ...
                            <div class="modal-footer">
                                <div class="hstack gap-2 justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-info" id="add-btn">Add Subcategory</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="modal fade" id="editAdmin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="tablelist-form" autocomplete="off" action="{{ route('instructor.subcategory.update') }}" method="POST">
                            @csrf
                            <div class="modal-body">                               
                            ...
                            <div class="modal-footer">
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                                    <button type="submit" class="btn btn-info" id="add-btn">Update Subcategory</button>
                                </div>
                            </div>
                        </form>
                    </div>
