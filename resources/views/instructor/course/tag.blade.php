                            ...
                            <div class="listjs-table" id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <button type="button" class="btn btn-info add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#addAdmin"><i class="ri-add-line align-bottom me-1"></i> Add New Tag</button>
                                        </div>
                                    </div>
                                    <div class="col-sm">
                                    ...
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="name">Tag</th>
                                        ...
                                        <tbody class="list form-check-all">
                                            ...
                                            <tr>
                                                ...
                                                <td><i class="bx bx-refresh"></i>
                                                    @if($data['status'] == '1')
                                                        <label for="updateStatus-{{ $data['id'] }}" class="badge bg-info-subtle text-info text-uppercase status cursor-pointer">Active</label> 
                                                ...
                                                <td>                                                    
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <form action="{{ route('instructor.tag.status') }}" method="POST" class="d-none">
                                                            @csrf
            ...
            <div class="modal fade" id="addAdmin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="tablelist-form" action="{{ route('instructor.tag.create') }}" method="POST" autocomplete="off">
                            @csrf
                            ...
                            <div class="modal-footer">
                                <div class="hstack gap-2 justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-info" id="add-btn">Add Tag</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="modal fade" id="editAdmin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="tablelist-form" autocomplete="off" action="{{ route('instructor.tag.update') }}" method="POST">
                            @csrf
                            <div class="modal-body">                               
                                <input type="hidden" name="id" id="edit_id">
                                
                                <div class="mb-3">
                                    <label for="edit_name" class="form-label">Tag</label>
                                    <input type="text" id="edit_name" name="name" class="form-control" placeholder="Enter Tag Name" required />
                                </div>
                            ...
                            <div class="modal-footer">
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                                    <button type="submit" class="btn btn-info" id="add-btn">Update Tag</button>
                                </div>
                            </div>
                        </form>
                    </div>
