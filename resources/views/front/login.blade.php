          ...
          <div class="col-md-5 mx-auto">
            <div class="auth-form">
              <div class="auth-header">
                ...
                <p>Login with your {{ $gs->title ?? '' }} account</p>
              </div>
              <form action="{{ route('front.login') }}" method="POST">
                ...
                <div class="form-group">
                  <div class="form-icon">
                    ...
                    <input name="email" value="{{ old('email') }}" type="email" class="form-control @error('email') is-invalid  @enderror" placeholder="Your Email" />
                    @error('email')
                ...
                <div class="auth-group">
                  ...
                  <a href="{{ route('front.UserForget') }}" class="auth-group-link">Forgot Password?</a>
                </div>
                <div class="auth-btn">
              ...
              <div class="auth-bottom">
                ...
                <p class="auth-bottom-text">Don't have an account? <a href="{{ route('front.UserRegister') }}">Register.</a></p>
              </div>
            </div>
          </div>
        </div>
