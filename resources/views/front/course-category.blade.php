...
<!-- Mirrored from live.themewild.com/edubo/course-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Nov 2025 10:12:14 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8" />
  ...
  <body>
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
              ...
              <div class="offcanvas-body gap-xl-4">
                    ...
                    <ul class="dropdown-menu fade-down">
                      <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="course-category-single.html">Software Development</a></li>
                          <li><a class="dropdown-item" href="course-category-single.html">Web Development</a></li>
                          <li><a class="dropdown-item" href="course-category-single.html">App Development</a></li>
                        </ul>
                      </li>
                      <li class="dropdown-submenu">
                        <a class="dropdown-item dropdown-toggle" href="#">Design</a>
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="course-category-single.html">Graphics Design</a></li>
                          <li><a class="dropdown-item" href="course-category-single.html">UX / UI Design</a></li>
                          <li><a class="dropdown-item" href="course-category-single.html">Figma Design</a></li>
                          <li><a class="dropdown-item" href="course-category-single.html">Icon Design</a></li>
                          <li><a class="dropdown-item" href="course-category-single.html">Logo Design</a></li>
                        </ul>
                      </li>
                      <li><a class="dropdown-item" href="course-category-single.html">Motion Graphics</a></li>
                      <li><a class="dropdown-item" href="course-category-single.html">Digital Marketing</a></li>
                      <li><a class="dropdown-item" href="course-category-single.html">Photography & Video</a></li>
                      <li><a class="dropdown-item" href="course-category-single.html">Office Productivity</a></li>
                      <li><a class="dropdown-item" href="course-category-single.html">Health & Fitness</a></li>
                      <li><a class="dropdown-item" href="course-category-single.html">Finance & Accounting</a></li>
                      ...
                      <li><a class="dropdown-item" href="course-category-single.html">English Learning</a></li>
                    </ul>
                  </li>
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu fade-down">
                      ...
                      <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="instructor.html">All Instructor</a></li>
                          <li><a class="dropdown-item" href="instructor-single.html">Instructor Single</a></li>
                          <li><a class="dropdown-item" href="become-instructor.html">Become Instructor</a></li>
                        </ul>
                      </li>
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu fade-down">
                      ...
                      <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="course-category.html">Category One</a></li>
                          <li><a class="dropdown-item" href="course-category-2.html">Category Two</a></li>
                          <li><a class="dropdown-item" href="course-category-single.html">Category Single</a></li>
                        </ul>
                      </li>
                      ...
                      <li><a class="dropdown-item" href="course-checkout-complete.html">Checkout Complete</a></li>
                    ...
                    <ul class="dropdown-menu fade-down">
                      ...
                      <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a class="dropdown-item" href="instructor-course.html">Instructor Courses</a></li>
                          <li><a class="dropdown-item" href="instructor-course-add.html">Instructor Course Add</a></li>
                          <li><a class="dropdown-item" href="instructor-review.html">Instructor Reviews</a></li>
                          <li><a class="dropdown-item" href="instructor-student.html">Instructor Students</a></li>
                          <li><a class="dropdown-item" href="instructor-payout.html">Instructor Payout</a></li>
                        </ul>
                      </li>
                      ...
                      <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="billing-address.html">Billing Address</a></li>
                          <li><a class="dropdown-item" href="billing-address-add.html">Address Add</a></li>
                        </ul>
                      </li>
                      <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a class="dropdown-item" href="support-ticket-detail.html">Support Ticket Details</a></li>
                        </ul>
                      </li>
                      <li class="dropdown-submenu">
                ...
                <div class="nav-right">
                  ...
                  <div class="nav-btn">
                    <a href="login.html" class="theme-btn"><span class="far fa-sign-in"></span> Sign In</a>
                  </div>
          ...
          <div class="sidebar-popup-contact">
            ...
            <ul>
              <li>
                ...
                <div class="content">
                  <h6>Email</h6>
                  <a href="https://live.themewild.com/cdn-cgi/l/email-protection#98f1f6fef7d8fde0f9f5e8f4fdb6fbf7f5"><span class="__cf_email__" data-cfemail="a6cfc8c0c9e6c3dec7cbd6cac388c5c9cb">[email&#160;protected]</span></a>
                </div>
              </li>
              <li>
                <div class="icon">
    ...
    <main class="main">
      ...
      <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/01.html)">
        <div class="container">
          <h2 class="breadcrumb-title">Category One</h2>
      ...
      <div class="category-area py-120">
        <div class="container">
          ...
          <div class="row g-4 justify-content-center wow fadeInUp" data-wow-delay=".25s">
            <div class="col-6 col-md-4 col-lg-3 col-xl-2">
              <a href="course-category-single.html" class="category-item">
                <div class="content">
                  <div class="icon">
                    <img src="assets/img/icon/development.svg" alt="" />
                  </div>
                  <div class="info">
                    <h6>Development</h6>
                    <p>150 Courses</p>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2">
              <a href="course-category-single.html" class="category-item">
                <div class="content">
                  <div class="icon">
                    <img src="assets/img/icon/marketing.svg" alt="" />
                  </div>
                  <div class="info">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2">
              <a href="course-category-single.html" class="category-item">
                <div class="content">
                  <div class="icon">
                    <img src="assets/img/icon/office.html" alt="" />
                  </div>
                  <div class="info">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2">
              <a href="course-category-single.html" class="category-item">
                <div class="content">
                  <div class="icon">
                    <img src="assets/img/icon/lifestyle.svg" alt="" />
                  </div>
                  <div class="info">
                    <h6>Lifestyle</h6>
                    <p>65 Courses</p>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2">
              <a href="course-category-single.html" class="category-item">
                <div class="content">
                  <div class="icon">
                    <img src="assets/img/icon/finance.svg" alt="" />
                  </div>
                  <div class="info">
                    <h6>Finance</h6>
                    <p>50 Courses</p>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2">
              <a href="course-category-single.html" class="category-item">
                <div class="content">
                  <div class="icon">
                    <img src="assets/img/icon/motion.svg" alt="" />
                  </div>
                  <div class="info">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2">
              <a href="course-category-single.html" class="category-item">
                <div class="content">
                  <div class="icon">
                    <img src="assets/img/icon/learn-2.svg" alt="" />
                  </div>
                  <div class="info">
          ...
          <div class="col-12 text-center">
            <a href="course-category.html" class="theme-btn mt-5"><span class="fad fa-rotate"></span> Load More</a>
          </div>
        </div>
      </div>
      <!-- category area end -->
                ...
                <div class="footer-widget-box">
                  ...
                  <ul class="footer-contact">
                    ...
                    <li>
                      ...
                      <div class="content">
                        <h6>Mail Us</h6>
                        <a href="https://live.themewild.com/cdn-cgi/l/email-protection#f39a9d959cb3968b929e839f96dd909c9e"><span class="__cf_email__" data-cfemail="31585f575e715449505c415d541f525e5c">[email&#160;protected]</span></a>
                      </div>
                    </li>
                  </ul>
                </div>
